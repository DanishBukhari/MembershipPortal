...
const ThankYou = () => {
  ...
  const message = type === 'walkin' 
    ? "Thanks for supporting YM Community! We have sent you a confirmation email. Excited to see you at the hub"
    : "Your payment was successful. Please check your email (including spam and promotions) for your client portal login details.";
  ...
  return (
    <div className="container mx-auto py-12 bg-[#FFFFFF] min-h-screen text-center flex items-center justify-center">
      <div className="p-6 bg-white rounded-lg shadow-lg">
        ...
        <p className="text-[#CF066C] mb-4">{message}</p>
